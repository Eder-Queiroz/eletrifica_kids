...
class Grid:
    ...
    def getWords(self):
        ...
        # Loop through rows (horizontal words)
        for i in range(self.nrows):  # Changed from hardcoded value
            for j in range(self.ncols):  # Changed from hardcoded value
        ...
        # Loop through columns (vertical words)
        for j in range(self.ncols):  # Changed from hardcoded value
            for i in range(self.nrows):  # Changed from hardcoded value
                ...
                elif (self.tile_grid[i][j].actual_letter != '') and (vertical_word != '') and (i != self.nrows - 1):
                    vertical_word += self.tile_grid[i][j].actual_letter
                elif (self.tile_grid[i][j].actual_letter == '') or (i == self.nrows - 1):
                    if (i == self.nrows - 1) and (vertical_word != ''):
                        vertical_word += self.tile_grid[i][j].actual_letter
